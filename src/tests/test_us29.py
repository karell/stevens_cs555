...
class TestDeceasedList(unittest.TestCase):
    def test_listOnlyDeceaseTrue(self):
        individual_dict = {}
        ...
        person2.alive = False
        person2.deathDate = datetime.datetime(2010,1,1)
        ...
        person3.alive = False
        person3.deathDate = datetime.datetime(2012,1,1)
        individual_dict.__setitem__(person3.id, person3)

        testDict = create_list_individual_characteristic.listDeceasedIndividuals(individual_dict)
